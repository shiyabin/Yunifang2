...
public class DiTuActivity extends AppCompatActivity {
   ...
   /* private MapView mMapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        difang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Bundle bundle = new Bundle();
                bundle.putString("地址", s);
                Intent intent = new Intent(DiTuActivity.this, DingDanActivity.class);
...
//            }
            ...
            Toast.makeText(DiTuActivity.this, "经度:"+lotitude.toString()+"纬度:"+longitude.toString(), Toast.LENGTH_SHORT).show();
